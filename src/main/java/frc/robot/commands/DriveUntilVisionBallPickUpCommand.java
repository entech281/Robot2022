...
public class DriveUntilVisionBallPickUpCommand extends EntechCommandBase {
    ...
    public DriveUntilVisionBallPickUpCommand(DriveSubsystem drive, VisionSubsystem vision, ColorSensorSubsystem color, double speed){
