...
public class ScaledDriveCommand extends EntechCommandBase {
     ...
     */
    public ScaledDriveCommand(DriveSubsystem drive, Joystick stick) {
        super(drive);
        m_drive = drive;
        m_stick = stick;
    }
    ...
    @Override
    public void execute() {
        m_drive.scaledDrive(m_stick.getY(), m_stick.getX());
    }
